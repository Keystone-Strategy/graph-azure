...
import * as exchange from './steps/exchange'
...
export const invocationConfig: IntegrationInvocationConfig<IntegrationConfig> = {
  instanceConfigFields: {
    ...
    ...exchange.invocationConfig.instanceConfigFields
  },

  validateInvocation: async (context: IntegrationExecutionContext<IntegrationConfig>) => {
    await validateInvocation(context)
    exchange.invocationConfig.validateInvocation && await exchange.invocationConfig.validateInvocation(context)
  },

  getStepStartStates: async (
    executionContext: IntegrationExecutionContext<IntegrationConfig>,
  ): Promise<StepStartStates> => {
    const allOtherStepStates = getStepStartStates(executionContext)
    const exchagneStepStates = exchange.invocationConfig.getStepStartStates ? await exchange.invocationConfig.getStepStartStates(executionContext) : {}
  ...
  integrationSteps: [
    ...
    ...exchange.invocationConfig.integrationSteps,
    // ...computeSteps,
    // ...cosmosdbSteps,
    // ...databaseSteps,
    // ...keyvaultSteps,
